...
4. curl -kL https://raw.github.com/cstrap/monaco-font/master/install-font-ubuntu.sh | bash   OR curl -kL https://raw.github.com/cstrap/monaco-font/master/install-font-centos.sh | bash
